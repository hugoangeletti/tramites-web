...
if (isset($_GET['id']) && $_GET['id'] == $_SESSION['hashColegiado']) {
    ...
    if (ENV == "prod") {
        ...
        curl_setopt($ch, CURLOPT_URL, 'https://www.colmed1.com/desarrollo/colegio/ws-colmed/cursos/buscar_cursos_activos.php?idColegiado='.$idColegiado);
    }
...
if ($continuar) {
    ?>
    <div class="col-md12"><h6>ESEM -> Cursos</h6></div>
