...
if (isset($_GET['id']) && $_GET['id'] <> "") {
    ...
    if (ENV == "prod") {
        curl_setopt($ch, CURLOPT_URL, 'https://webservices.colmed1.com.ar/colegio/ws-colmed/colegiado/imprimir_certificado_cobertura_seguro.php?id='.$hashColegiado);
    } else {
        curl_setopt($ch, CURLOPT_URL, 'https://www.colmed1.com/desarrollo/colegio/ws-colmed/colegiado/imprimir_certificado_cobertura_seguro.php?id='.$hashColegiado);
    }
...
if ($continuar) {
?>
    <div class="col-md12"><h6>Seguro -> Imprimir certificado de cobertura</h6></div>
    <div class="container-fluid p-3" style="background-color: #8699a4 ; color: white">
        <div class="row">
            ...
            <div class="col-md-2">
                <a href="tramites.php" class="btn btn-dark" role="button">Volver</a>
            </div>
        </div>
    </div>
    <?php 
    ...
    ?>
        <div class="container-fluid p-3" >
           <embed src='data:application/pdf;base64,<?php echo $certificado; ?>' height="600px" width='100%' type='application/pdf'>   
        </div> 
    <?php 
    } else {
    ?>
        <div class="container-fluid p-3" >
           <h4>ERROR: <?php echo $respuesta['mensaje']; ?></h4>   
        </div>
    <?php
    }
} else {
