...
if (isset($_GET['id']) && $_GET['id'] == $_SESSION['hashColegiado']) {
    ...
    if (ENV == "prod") {
        curl_setopt($ch, CURLOPT_URL, 'https://webservices.colmed1.com.ar/colegio/ws-colmed/colegiado/buscar_datos_contacto.php?idColegiado='.$idColegiado);
    } else {
        curl_setopt($ch, CURLOPT_URL, 'http://www.colmed1.com/desarrollo/colegio/ws-colmed/colegiado/buscar_datos_contacto.php?idColegiado='.$idColegiado);
    }
